microservice.controller('loginController',function($scope, $location,__env, $route,loginService,$cookieStore,$rootScope){
	alert("in controller"+__env.authserviceUrl);
 	$scope.error = false;
